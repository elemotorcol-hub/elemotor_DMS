...
-- AlterTable
ALTER TABLE `workshop_images` ADD COLUMN `public_id` VARCHAR(255) NULL;

-- AlterTable
ALTER TABLE `workshop_services` MODIFY `service_type` ENUM('maintenance', 'chargers', 'body_paint', 'electric_diagnostics', 'tires', 'brakes', 'general') NOT NULL;
